...
namespace Indexiz\AdminCustomizer\Block\Adminhtml\Login;
...
class Logo extends Template
{
     ...
     *
     */
    const XML_PATH_ADMIN_LOGO = 'admincustomizer/logos/admin_logo';
    ...
    protected function getDefaultLogoUrl(): string
    {
        ...
        try {
            if (strtolower($edition) === 'enterprise') {
                return $this->getViewFileUrl('Magento_Enterprise::images/login-logo.svg');
            }
        } catch (\Exception $e) {
            // fallback handled below
        }

        return $this->getViewFileUrl('images/magento-logo.svg');
    }
